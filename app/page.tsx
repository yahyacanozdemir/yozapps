...
import AppShowcase, { type ShowcaseConfig } from "@/components/AppShowcase";
import ComingSoon from "@/components/ComingSoon";
import Social from "@/components/Social";
import ContactForm from "@/components/ContactForm";
import Footer, { About } from "@/components/Footer";

const holes: ShowcaseConfig = {
  id: "holes",
  prefix: "holes",
  letters: "HOLES",
  htmlId: "apps",
...
export default function Home() {
  return (
    <main>
      <Nav />
      <Hero />
      <AppShowcase config={holes} />
      <AppShowcase config={safeoto} />
      <ComingSoon />
      <About />
      <Social />
      <ContactForm />
